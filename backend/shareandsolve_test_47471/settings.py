"""
Django settings for shareandsolve_test_47471 project.
...
ROOT_URLCONF = 'shareandsolve_test_47471.urls'
...
WSGI_APPLICATION = 'shareandsolve_test_47471.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "shareandsolve_test_47471 API",
    "DESCRIPTION": "API documentation for shareandsolve_test_47471 App",
    "VERSION": "v1",
}
